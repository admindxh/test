...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.indexOf('baaa67449f5749a534bb7b2cc39c20bc')>0){
                    	alert("登录超时，请重新登录");
                ...
                error: function (xhr, ajaxOptions, thrownError) {
                    Metronic.stopPageLoading();
                    pageContentBody.html('<h4>内容加载失败，请重新登录尝试</h4>');
                }
            });
        });
        ...
        // handle ajax links within header menu
        jQuery('.nav.navbar-nav.pull-right').on('click', ' li > a.ajaxify', function (e) {
        	e.preventDefault();
        	Metronic.scrollTop();
