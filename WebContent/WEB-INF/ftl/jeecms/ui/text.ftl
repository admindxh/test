...
<#macro text
	...
	onclick="" ondblclick="" onmousedown="" onmouseup="" dateformat=""  onmouseover="" onmousemove="" onmouseout="" onfocus="" onblur="" onkeypress="" onkeydown="" onkeyup="" onselect="" onchange=""
	>
...
<#if dateformat!=""> data-date-format="${dateformat}"</#if><#rt/>
