...
<#macro selfDefineWidget
	...
	colspan="" width="100" class="form-control" helpPosition="2"
	>
...
<#elseif type=="5">
<@p.text colspan=colspan width=width class=class label=label  name=name value=value readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" size=size?string help=help helpPosition=helpPosition/>
<#elseif type=="6">
